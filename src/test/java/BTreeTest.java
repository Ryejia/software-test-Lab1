...
public class BTreeTest {
    ...
    @BeforeEach
    void setUp() {
        firstBTree = new BTree(5);
        secondBTree = new BTree(5);
    ...
    void insert2() {
        ...
        expected = new ArrayList<>(Arrays.asList(8, 9, 10, 11, 15, 17, 20));
        actual = new ArrayList<>();
    ...
    void remove2() {
        ...
        expected = new ArrayList<>(Arrays.asList(8, 9, 11, 15, 20));
        actual = new ArrayList<>();
        secondBTree.show(actual);
        Assertions.assertEquals(expected, actual);
    }
    ...
    void remove3() {
        ...
        expected = new ArrayList<>(Arrays.asList(9, 10, 11, 15, 20));
        actual = new ArrayList<>();
        secondBTree.show(actual);
        Assertions.assertEquals(expected, actual);
    }
